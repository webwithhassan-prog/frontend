// Name, ISO 3166-1 alpha-2 code, and calling code for every dialable
// country/territory. The flag is derived from the ISO code at render time
// (see flagEmoji below) rather than stored per-entry.
export const COUNTRY_CODES = [
  ...
  { name: "Dominican Republic", iso: "DO", dial: "1849" },
  ...
  { name: "Hong Kong SAR China", iso: "HK", dial: "852" },
  ...
  { name: "Macao SAR China", iso: "MO", dial: "853" },
...
// Converts an ISO 3166-1 alpha-2 code into its flag emoji via the two
// matching Regional Indicator Symbol code points — no per-country emoji to
// keep in sync.
